...
//		Vector<String> list = new Vector<String>();
		...
		객체저장 : add() 
			...
			add(인덱스, 인스턴스) : 데이터 저장시 인덱스를 직접
				...
				주의해야한다. 만약 중복된 인덱스가 있다면 삽입(끼워넣기)
				이된다. 
		 */
		list.add("소녀시대");
		list.add("빅뱅");
...
//		list.add(5,"소방차ㅋㅋ"); //에러발생됨
		...
		*/
		...
		중복저장 : List는 배열의 특성을 가지므로 데이터를 중복저장
			할수있다. 동일한 데이터라도 index로 구분할 수 있기때문이다.
		...
		*/
		...
		/*
		컬렉션 출력시에는 아래 3가지 방법 중 하나를 사용하면된다. 
		...
		/*
		방법2 : 확장 for 문의 경우 인덱스없이 전체 원소를 반복해
		...
		*/
		...
		/*
		방법2 : 인스턴스의 참조값을 통해 삭제한다. 이 경우에는 삭제에
			성공하면 true가 반환된다. 즉 boolean 타입의 반환값을
			가진다. 
		 */
